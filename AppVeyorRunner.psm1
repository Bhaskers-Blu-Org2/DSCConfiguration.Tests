...
function New-ResourceGroupforTests {
    ...
    $AutomationAccount = New-AzureRMAutomationAccount -ResourceGroupName "TestAutomation-$env:APPVEYOR_BUILD_ID" -Name "DSCValidation-$env:APPVEYOR_PROJECT_NAME" -Location $Location
}
